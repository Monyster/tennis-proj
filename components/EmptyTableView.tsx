...
/**
 * Empty table tennis table visualization for lobby
 * Shows table with 0:0 score and empty positions
 */
      ...
      <div className="mb-4 bg-gray-900 rounded-lg p-4 shadow-lg">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex-1 text-center">
            ...
            <div className="text-5xl font-bold text-gray-600 tabular-nums">
              0
            </div>
          </div>
